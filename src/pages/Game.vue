...
<style scoped>
.game-page { height: 100%; display: flex; flex-direction: column; }
.toolbar { padding: 8px 12px; display: flex; gap: 12px; align-items: center; background: rgba(255,255,255,0.06); }
.viewport { flex: 1; }
</style>
